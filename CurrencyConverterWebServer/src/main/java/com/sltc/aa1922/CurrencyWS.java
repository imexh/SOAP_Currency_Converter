...
public class CurrencyWS
{
    ...
    public double convert(double amountInSourceCurrency, String sourceCurrency, String targetCurrency) throws IOException, ParseException {
        ...
        Double sourceCurrencyRate = Double.valueOf(readJson.conversionRates.get(sourceCurrency).toString());
        Double targetCurrencyRate = Double.valueOf(readJson.conversionRates.get(targetCurrency).toString());
    ...
    public static void main(String[] args){
        ...
        Endpoint.publish("http://localhost:8888/CurrencyConversionWebServiceAA1922", new CurrencyWS());
    }
}
